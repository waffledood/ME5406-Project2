...
class A2CNet(nn.Module):
    def __init__(self, image_shape, data_shape, n_actions):
        ...
        self.fc2 = nn.Sequential(nn.Linear(conv_out_size + fc_out_size, 512), nn.ReLU())  # 1x512
        self.mu = nn.Sequential(nn.Linear(512, n_actions), nn.Tanh(),)
        self.var = nn.Sequential(nn.Linear(512, n_actions), nn.Softplus(),)
